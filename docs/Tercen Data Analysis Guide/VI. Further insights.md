...
| -------------- | ------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------ |
| **Strength**   | Easy interpretation: positive FC = activation, negative = inhibition.                                  | Autophosphorylation sites are valuable.                                                                                                    |
| **Key caveat** | Predicted values → must pre-select kinases with high scores (specificity score minimally > 0.7 or > 1) | - Protein may not be present in lysate.<br>- Phosphorylation → different outcomes (induction or inhibition of protein or other functions). |
